...
0
|| checktplrefresh('./template/sxp_bbs_105s/forum/viewthread.htm', './template/sxp_bbs_105s/forum/viewthread_node.htm', 1502862726, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/sxp_bbs_105s', 'forum/viewthread')
|| checktplrefresh('./template/sxp_bbs_105s/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1502862726, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/sxp_bbs_105s', 'forum/viewthread')
|| checktplrefresh('./template/sxp_bbs_105s/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1502862726, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/sxp_bbs_105s', 'forum/viewthread')
|| checktplrefresh('./template/sxp_bbs_105s/forum/viewthread.htm', './template/default/common/seditor.htm', 1502862726, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/sxp_bbs_105s', 'forum/viewthread')
|| checktplrefresh('./template/sxp_bbs_105s/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1502862726, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/sxp_bbs_105s', 'forum/viewthread')
|| checktplrefresh('./template/sxp_bbs_105s/forum/viewthread.htm', './template/default/common/upload.htm', 1502862726, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/sxp_bbs_105s', 'forum/viewthread')
|| checktplrefresh('./template/sxp_bbs_105s/forum/viewthread.htm', './template/default/common/seccheck.htm', 1502862726, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/sxp_bbs_105s', 'forum/viewthread')
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="發新帖"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="發新帖" /></a><?php } } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回復"><img src="<?php echo IMGDIR;?>/pn_reply.png" alt="回復" /></a>
<?php } ?>
...
<div id="post_<?php echo $post['pid'];?>" class="sxpview" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>><?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
...
<?php } ?>
<strong>
<a href="<?php if($post['first']) { ?>forum.php?mod=viewthread&tid=<?php echo $_G['tid'];?><?php echo $fromuid;?><?php } else { ?>forum.php?mod=redirect&goto=findpost&ptid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?><?php echo $fromuid;?><?php } ?>"  <?php if($fromuid) { ?>title="您的朋友訪問此鏈接後，您將獲得相應的積分獎勵"<?php } ?> id="postnum<?php echo $post['pid'];?>" onclick="setCopy(this.href, '帖子地址複製成功');return false;"<?php if(isset($post['isstick']) && $close_leftinfo) { ?> class="sxp2"<?php } elseif($post['number'] == -1 && $close_leftinfo) { ?> class="sxp1"<?php } elseif($post['number'] == 1) { ?> class="sxp1"<?php } elseif($post['number'] == 2) { ?> class="sxp2"<?php } elseif($post['number'] == 3) { ?> class="sxp3"<?php } elseif($post['number'] == 4) { ?> class="sxp4"<?php } ?>>
...
<div id="postlistreply" class="pl sxpview"><div id="post_new" class="viewthread_table" style="display: none"></div></div>
...
<a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="發新帖"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="發新帖" /></a>
<?php } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_replytmp" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回復"><img src="<?php echo IMGDIR;?>/pn_reply.png" alt="回復" /></a>
<?php } ?>
</div>

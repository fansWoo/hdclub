...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1502857661, '2', './data/template/2_2_member_login.tpl.php', './template/sxp_bbs_105s', 'member/login')

...
<div class="sxpfooter">
        <div class="sxpfttop">
        	<div class="sxpw1100">
            	<div class="sxpftpad">
                	<h3><?php if(is_array($_G['setting']['footernavs'])) foreach($_G['setting']['footernavs'] as $nav) { if($nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) ||
                                !$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile' || $nav['id'] == 'darkroom'))) { ?><?php echo $nav['code'];?><span class="pipe">|</span><?php } } ?><div class="clear"></div>
</h3>
                    <div class="clear"></div>
                    <ul>
                    	<li>Copyright &nbsp;&nbsp;&copy;2015-2017<a href="http://www.discuz.net"> Comsenz Inc.</a>&nbsp;&nbsp;<a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a>&nbsp;&nbsp;

Powered by&copy;Discuz!
<?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } ?>&nbsp;&nbsp;<?php if($_G['setting']['icp']) { ?>( <a href="http://www.miitbeian.gov.cn/" target="_blank" ><?php echo $_G['setting']['icp'];?></a> )<?php } ?><?php if(!empty($_G['setting']['pluginhooks']['global_footerlink'])) echo $_G['setting']['pluginhooks']['global_footerlink'];?>	
</li>
<li style="line-height:1.5em;">本網站特別聘請 中華海事法律事務所 為本站法律顧問 GMT+8, 2017-7-27 15:57 , Processed in 0.033165 second(s), 3 queries , Gzip On, Apc On.</li>
                    </ul>
                </div>
                ...
                <div class="sxpftright" style="float:right;">
                    ...
                    <div class="sxpftshare" style="width:1200px;">
                    	<ul>
                        	<li class="sxpftli1"><a href="<?php echo $sxp_lang['101'];?>" target="_blank"><span></span></a></li>
                            <li class="sxpftli2">
                            	<a href="<?php echo $sxp_lang['102'];?>" target="_blank"><span></span></a>
                            	<b>
                                    <img src="<?php echo $_G['style']['styleimgdir'];?>/erweima.jpg" />
                                </b>
                            </li>
                            <li class="sxpftli3"><a href="<?php echo $sxp_lang['103'];?>" target="_blank"><span></span></a></li>
                            <li class="sxpftli4"><a href="<?php echo $sxp_lang['104'];?>" target="_blank"><span></span></a></li>
                            <div class="clear"></div>
                        </ul>
                    </div>

...
0
|| checktplrefresh('./template/sxp_bbs_105s/forum/forumdisplay.htm', './template/sxp_bbs_105s/forum/forumdisplay_leftside.htm', 1502857559, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/sxp_bbs_105s', 'forum/forumdisplay')
|| checktplrefresh('./template/sxp_bbs_105s/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1502857559, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/sxp_bbs_105s', 'forum/forumdisplay')
|| checktplrefresh('./template/sxp_bbs_105s/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1502857559, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/sxp_bbs_105s', 'forum/forumdisplay')
|| checktplrefresh('./template/sxp_bbs_105s/forum/forumdisplay.htm', './template/sxp_bbs_105s/forum/forumdisplay_list.htm', 1502857559, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/sxp_bbs_105s', 'forum/forumdisplay')
|| checktplrefresh('./template/sxp_bbs_105s/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1502857559, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/sxp_bbs_105s', 'forum/forumdisplay')
|| checktplrefresh('./template/sxp_bbs_105s/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1502857559, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/sxp_bbs_105s', 'forum/forumdisplay')
|| checktplrefresh('./template/sxp_bbs_105s/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1502857559, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/sxp_bbs_105s', 'forum/forumdisplay')
...
<div class="listen_bdlc">
<dl id="lf_fav" class="bdl_fav"><?php if(is_array($leftside['favorites'])) foreach($leftside['favorites'] as $favfid => $fdata) { ?><dd>
...
<?php } else { ?>
<h2>版塊導航</h2>
<?php } if(is_array($leftside['forums'])) foreach($leftside['forums'] as $upfid => $gdata) { ?><div class="listen_bdlc">
...
<h1 class="xs2">
<a id="viewtitle" href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><?php echo $_G['forum']['name'];?></a>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=heat&amp;orderby=heats<?php echo $forumdisplayadd['heat'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'heat') { ?> xw1<?php } ?>">熱門</a>
<span class="pipe">|</span>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="<?php if($_GET['filter'] == 'hot') { ?> xw1<?php } ?>">熱帖</a>
<span class="pipe">|</span>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=digest&amp;digest=1<?php echo $forumdisplayadd['digest'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'digest') { ?> xw1<?php } ?>">精華</a>
...
<?php if(!empty($_G['forum']['picstyle'])) { ?><a<?php if(empty($_G['cookie']['forumdefstyle'])) { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=yes" class="chked y"<?php } else { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=no" class="unchk y"<?php } ?> title="圖片模式瀏覽帖子">圖片模式</a><?php } ?>
<div class="z">
...
<span class="showmenu"><?php if($_GET['rewardtype'] == '') { ?>全部懸賞<?php } elseif($_GET['rewardtype'] == '1') { ?>進行中<?php } elseif($_GET['rewardtype'] == '2') { ?>已解決<?php } ?></span>
</a>
<?php } ?>
<a id="filter_special" href="javascript:;" class="showmenu_outer" onclick="showMenu(this.id)">
<span class="showmenu"><?php if($_GET['specialtype'] == 'poll') { ?>投票<?php } elseif($_GET['specialtype'] == 'trade') { ?>商品<?php } elseif($_GET['specialtype'] == 'reward') { ?>懸賞<?php } elseif($_GET['specialtype'] == 'activity') { ?>活動<?php } elseif($_GET['specialtype'] == 'debate') { ?>辯論<?php } else { ?>全部主題<?php } ?></span>
</a>
<a id="filter_dateline" href="javascript:;" class="showmenu_outer" onclick="showMenu(this.id)">
<span class="showmenu"><?php if($_GET['dateline'] == 86400) { ?>一天<?php } elseif($_GET['dateline'] == 172800) { ?>兩天<?php } elseif($_GET['dateline'] == 604800) { ?>一周<?php } elseif($_GET['dateline'] == 2592000) { ?>一個月<?php } elseif($_GET['dateline'] == 7948800) { ?>三個月<?php } else { ?>全部時間<?php } ?></span>
</a>
...
<span class="showmenu"><?php if($_GET['orderby'] == 'dateline') { ?>發帖時間<?php } elseif($_GET['orderby'] == 'replies') { ?>回復/查看<?php } elseif($_GET['orderby'] == 'views') { ?>查看<?php } elseif($_GET['orderby'] == 'lastpost') { ?>最後發表<?php } elseif($_GET['orderby'] == 'heats') { ?>熱門<?php } else { ?>默認排序<?php } ?></span>
</a>
...
<?php } else { ?>
<span class="mi_f14">標題</span>
<?php } ?>
</div>
<div class="bm_c" style="padding:0;"<?php if(!(empty($_G['forum']['picstyle']) || $_G['cookie']['forumdefstyle'])) { } ?>>
...
<tr>
<td>
<div class="mi_postlist cl"<?php if(!(empty($_G['forum']['picstyle']) || $_G['cookie']['forumdefstyle'])) { ?> <?php } ?>>
<div class="mi_listtx">
...
<h2 class="cl">
<span class="mi_icn"><img src="<?php echo IMGDIR;?>/ann_icon.gif" alt="公告" /></span>
<span class="mi_common"><strong class="xst">公告: <?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } ?></strong></span>
</h2>
<p>
<em class="mi_user"><a href="home.php?mod=space&amp;uid=<?php echo $announcement['authorid'];?>" c="1"><?php echo $announcement['author'];?></a></em>
<em><?php echo $sxp_lang['10'];?> <?php echo $announcement['starttime'];?></em>
</p>
</div>
</td>
</tr>
...
<style>
.ie6 #threadlisttableid,.ie6 #threadlisttableid tbody,.ie6 #threadlisttableid .mi_postlist{position:relative;}
.mi_o{position:absolute;top:1px;left:1px;}
</style>
...
<tr><td>
<div class="mi_separatorline">
<h3><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版塊主題</a><?php } else { ?>版塊主題<?php } ?></h3>
</div>
</td></tr>
</tbody>
...
<?php if($tr != $thread['displayorder']) { if($thread['displayorder'] == 1) { ?>
<tbody>
<tr class="ts">
<?php if($_G['forum']['ismoderator'] && !$_G['gp_archiveid']) { } ?>
<td colspan="4" style="background: #333; padding: 8px 0 8px 8px;"> <font color=Green><b>本版置顶</b></font></td>
</tr>
</tbody>
...
<tr class="ts">
<?php if($_G['forum']['ismoderator'] && !$_G['gp_archiveid']) { } ?>
<td colspan="4" style="background: #333; padding: 8px 0 8px 8px;"> <font color=Blue><b>分區置顶</b></font></td>
</tr>
</tbody>
...
<tr class="ts">
<?php if($_G['forum']['ismoderator'] && !$_G['gp_archiveid']) { } ?>
<td colspan="4" style="background: #333; padding: 8px 0 8px 8px;"> <font color=red><b>全局置顶</b></font></td>
</tr>
</tbody>
...
<div class="mi_listtx"<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?> style="position:relative;"<?php } ?>>
<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
<span class="mi_o">
...
<?php } ?>
<a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" class="mi_listtxs" target="_blank"><?php echo avatar($thread[authorid],small);?></a>
</div>
<h2 class="cl">
...
<?php if($_G['setting']['threadhidethreshold'] && $thread['hidden'] >= $_G['setting']['threadhidethreshold']) { ?><span class="mi_hs">隱藏</span>&nbsp;<?php } if($thread['icon'] >= 0) { ?>
...
<span id="rushtimer_<?php echo $thread['tid'];?>" class="mi_tc"> 【還有 <span id="rushtimer_body_<?php echo $thread['tid'];?>"></span> <script language="javascript">settimer(<?php echo $rushinfo[$thread['tid']]['timer'];?>, 'rushtimer_body_<?php echo $thread['tid'];?>');</script><?php if($rushinfo[$thread['tid']]['timertype'] == 'start') { ?> 開始 <?php } else { ?> 結束 <?php } ?> 】</span>
<?php } } if($stemplate && $sortid) { ?><?php echo $stemplate[$sortid][$thread['tid']];?><?php } if($thread['readperm']) { ?> - <span class="mi_tc">[閱讀權限 <b><?php echo $thread['readperm'];?></b>]</span><?php } if($thread['price'] > 0) { if($thread['special'] == '3') { ?>
- <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype=1" title="只看進行中的"><span class="mi_tc">[懸賞 <b><?php echo $thread['price'];?></b> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['2']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['2']]['title'];?>]</span></a>
<?php } else { ?>
- <span class="mi_tc">[售價 <b><?php echo $thread['price'];?></b> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?>]</span>
<?php } } elseif($thread['special'] == '3' && $thread['price'] < 0) { ?>
- <span class="mi_tc"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype=2" title="只看已解決的">[已解決]</a></span>
<?php } if($thread['attachment'] == 2) { ?>
<img src="<?php echo IMGDIR;?>/image_s.gif" alt="attach_img" title="圖片附件" align="absmiddle" />
...
- <span class="mi_tc">[回帖獎勵 <strong> <?php echo $thread['replycredit'];?></strong> ]</span>
<?php } ?>
...
<?php } } if(CURMODULE == 'guide') { ?>
<span class="mi_tc"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $thread['fid'];?>" target="_blank"><?php echo $forumnames[$thread['fid']]['name'];?></a></span>
<?php } ?>
</span>
</h2>
<p>
<span class="y">
<em class="mi_view"><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></em>
<em class="mi_reply"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>"><?php echo $thread['allreplies'];?></a></em>
</span>
...
<em><span<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo $thread['dateline'];?></span> <?php echo $sxp_lang['3'];?><?php if($thread['typehtml'] || $thread['sorthtml']) { ?><?php echo $sxp_lang['4'];?><?php } ?></em>
...
<?php } ?>
<em><?php echo $sxp_lang['5'];?> <a href="<?php if($thread['digest'] != -2 && !$thread['ordertype']) { ?>forum.php?mod=redirect&tid=<?php echo $thread['tid'];?>&goto=lastpost<?php echo $highlight;?>#lastpost<?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?><?php if(!$thread['ordertype']) { ?>&page=<?php echo max(1, $thread['pages']);; } } ?>" ><?php echo $thread['lastpost'];?></a></em>
<em>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['icontid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>" title="<?php if($thread['displayorder'] == 1) { ?>本版置頂主題 - <?php } if($thread['displayorder'] == 2) { ?>分類置頂主題 - <?php } if($thread['displayorder'] == 3) { ?>全局置頂主題 - <?php } if($thread['displayorder'] == 4) { ?>多版置頂主題 - <?php } if($thread['folder'] == 'lock') { ?>關閉的主題 - <?php } if($thread['special'] == 1) { ?>投票 - <?php } if($thread['special'] == 2) { ?>商品 - <?php } if($thread['special'] == 3) { ?>懸賞 - <?php } if($thread['special'] == 4) { ?>活動 - <?php } if($thread['special'] == 5) { ?>辯論 - <?php } if($thread['folder'] == 'new') { ?>有新回復 - <?php } if($thread['replies'] == '0' && $thread['dbdateline']>time()-43200) { ?><?php echo $sxp_lang['6'];?> - <?php } ?>
新窗口打開" target="_blank">
...
<a href="javascript:;" rel="<?php echo $multipage_more;?>" curpage="<?php echo $page;?>" id="autopbn" totalpage="<?php echo $maxpage;?>" picstyle="<?php echo $_G['forum']['picstyle'];?>" forumdefstyle="<?php echo $_G['cookie']['forumdefstyle'];?>"><i></i><?php echo $sxp_lang['8'];?></a>
<script src="<?php echo $_G['setting']['jspath'];?>autoloadpage.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } else { ?>
<div id="pgbtn" class="pgbtn"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=<?php echo $filter;?>&amp;orderby=<?php echo $_GET['orderby'];?><?php echo $forumdisplayadd['page'];?>&amp;<?php echo $multipage_archive;?>&amp;page=<?php echo $nextpage;?>" hidefocus="true"><?php echo $sxp_lang['9'];?></a></div>
<?php } } ?>
<div class="mi_pgs cl">	
...
<?php if(!IS_ROBOT) { ?>
<div id="filter_special_menu" class="p_pop mi_pop" style="display:none" change="location.href='forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&filter='+$('filter_special').value">
<ul>
...
<div id="filter_reward_menu" class="p_pop mi_pop" style="display:none" change="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype='+$('filter_reward').value">
<ul>
...
<div id="filter_dateline_menu" class="p_pop mi_pop" style="display:none">
<ul>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">全部時間</a></li>
...
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline&amp;dateline=172800<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">兩天</a></li>
...
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline&amp;dateline=2592000<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">一個月</a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline&amp;dateline=7948800<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">三個月</a></li>
</ul>
</div>
<?php if(!$_G['setting']['closeforumorderby']) { ?>
<div id="filter_orderby_menu" class="p_pop mi_pop" style="display:none">
<ul>
...
<div class="drag sxp_tiezi"><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="發新帖"></a></div>
<?php } ?>
<div class="clear height20"></div>
<div class="drag"><!--[diy=diysd1]--><div id="diysd1" class="area"></div><!--[/diy]--></div>
<div class="drag"><!--[diy=diysd5]--><div id="diysd5" class="area"></div><!--[/diy]--></div>

...
<div class="mbm">搜索版塊: <input type="text" class="px vm" onkeyup="forumlistsearch(this.value)" /></div>
<ul class="jump_bdl cl">
<li>
<p class="bbda xg1">所有版塊</p><?php if(is_array($forumlist)) foreach($forumlist as $upfid => $gdata) { if($gdata['sub']) { ?>
...
<li>
<p class="bbda xg1">最近瀏覽</p><?php if(is_array($visitedforums)) foreach($visitedforums as $fid => $forumname) { ?><p<?php if($_GET['jfid'] == $fid) { ?> class="a"<?php } ?>><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $fid;?>"><?php echo $forumname;?></a></p>
<?php } ?>
</li>

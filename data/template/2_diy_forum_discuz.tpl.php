...
0
|| checktplrefresh('./template/sxp_bbs_105s/forum/discuz.htm', './template/sxp_bbs_105s/common/pubsearchform.htm', 1502857484, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/sxp_bbs_105s', 'forum/discuz')
;?><?php include template('common/header'); ?><div class="wp"><!--[diy=diy1004]--><div id="diy1004" class="area"></div><!--[/diy]--></div>
<div class="clear"></div>
...
<?php if(empty($gid)) { ?>
<div class="wp"><!--[diy=diy998]--><div id="diy998" class="area"></div><!--[/diy]--></div>
<div class="sxpscbar">
<div class="sxp_scbar"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<?php } ?></div>
<div class="sxpsd_area1"><!--[diy=diy895]--><div id="diy895" class="area"></div><!--[/diy]--></div>
</div>
<div class="clear height20"></div>
<div class="wp"><!--[diy=diy898]--><div id="diy898" class="area"></div><!--[/diy]--></div>
<div class="wp"><!--[diy=diy897]--><div id="diy897" class="area"></div><!--[/diy]--></div>
<div class="wp"><!--[diy=diy_chart]--><div id="diy_chart" class="area"></div><!--[/diy]--></div>	
<?php } ?>
...
<div class="z"><ul>
<li class="t">今日:<em><?php echo $todayposts;?></em></li>
<li class="ye">昨日:<em><?php echo $postdata['0'];?></em></li>
<li class="p">帖子:<em><?php echo $posts;?></em></li>
<li class="m">會員:<em><?php echo $_G['cache']['userstats']['totalmembers'];?></em></li>
</ul></div>						
<div class="y">
<?php if(!empty($_G['setting']['pluginhooks']['index_nav_extra'])) echo $_G['setting']['pluginhooks']['index_nav_extra'];?>
<?php if($_G['cache']['userstats']['newsetuser']) { ?>歡迎新會員:<em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?>
</div>
</div>
<?php } ?>	
<div class="clear height20"></div>	
...
<div class="drag"><!--[diy=diyw2]--><div id="diyw2" class="area"></div><!--[/diy]--></div>
<?php if($sxp_ggg==1) { ?>
<div class="sxp_ggg">
<div class="y"><?php if(!empty($_G['setting']['pluginhooks']['index_status_extra'])) echo $_G['setting']['pluginhooks']['index_status_extra'];?></div>
<?php if(empty($gid) && $announcements) { ?>
<div class="z"><h3><?php echo $sxp_lang['2'];?>:&nbsp;</h3></div>
<div class="y">
<div id="an">
<dl class="cl">
...
<div class="clear height20"></div>
<?php } ?>
<div class="drag"><!--[diy=diyw3]--><div id="diyw3" class="area"></div><!--[/diy]--></div>
...
<?php } } ?>
<td class="fl_g"<?php if($forumcolwidth) { ?> width="<?php echo $forumcolwidth;?>"<?php } ?>>
<div class="fl_icn_g sxpicon_g"<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="width: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
<?php if($forum['icon']) { ?>
<?php echo $forum['icon'];?>
<?php } else { ?>
<a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?>><img src="<?php echo IMGDIR;?>/forum2<?php if($forum2['folder']) { ?>_new<?php } ?>.gif" alt="<?php echo $forum['name'];?>" /></a>
<?php } ?>
</div>
...
<?php if($forum['description']) { ?><dd><?php echo $forum['description'];?></dd><?php } if(empty($forum['redirect'])) { ?>


<dd><em>主題: <?php echo dnumber($forum['threads']); ?></em>, <em>帖數: <?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
...
<div class="drag"><!--[diy=diyw09]--><div id="diyw09" class="area"></div><!--[/diy]--></div>

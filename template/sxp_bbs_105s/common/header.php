...
<script src="{$_G['style']['styleimgdir']}/js/sxpSlide.js" type="text/javascript"></script>
...
<div id="sxp_nv"><div id="sxp_nv2">     
              ...
              <div id="sxp_nv3">
            	...
            	<div id="sxp_nv4"><a href="javascript:;" id="qmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu($_G[fid]);})">{lang my_nav}</a></div>
                <div class="clear"></div>
</div></div> 
<!--{if $sxp_nv==1}--><script type="text/javascript" src="$_G['style'][styleimgdir]/js/nv.js"></script><!--{/if}-->
